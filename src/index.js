...
// make up an id to pass in - arrayIndex
...
const counters = (state, action) => {
    ...
    switch (action.type) {
        ...
        case ADD_COUNTER:
            return {
                // add a counter ( an object with a state ) and return the new array
...
// c is for count
// return what I want  to put into the array - a react component
